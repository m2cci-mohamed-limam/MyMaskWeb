 ...
 * @author flori
 */
@WebServlet(name = "ListerMasquesCtrler", urlPatterns = {"/ListerMasquesCtrler"})
public class ListerMasquesCtrler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List MasqComp = MasqueDAO.trouverTousLesMasques(ds);
            request.setAttribute("MasqComp", MasqComp);
            request.getRequestDispatcher("/WEB-INF/listeTousLesMasques.jsp").forward(request, response);
//            List<Masque> lesMasques = MasqueDAO.trouverTousLesMasques(ds);
